...
export default function FloatingActions({
  ...
  return (
    <div
      className={cn(
        /* lifted clear of the mobile bottom nav; --bottom-nav-h is 0 from lg up */
        "fixed bottom-[calc(var(--bottom-nav-h)+1rem)] right-4 z-50 flex flex-col items-end gap-3 transition-all duration-500 lg:right-5",
